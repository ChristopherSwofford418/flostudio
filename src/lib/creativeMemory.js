...
const labels = {
  brand_dna_saved:'Brand DNA saved', product_ingested:'Product facts captured', campaign_created:'Campaign created', concept_generated:'Campaign angles created', concept_selected:'Creative thesis selected', concept_edited:'Creative thesis edited', post_created:'Platform post created', asset_rendered:'Creative variant rendered', asset_attached:'Creative attached', post_approved:'Human approval', post_rejected:'Human rejection', post_rewritten:'Copy revised', post_published:'Provider publishing recorded', campaign_scheduled:'Campaign scheduled', outcome_recorded:'Outcome recorded', experiment_created:'Experiment planned', variant_created:'Experiment variant created', experiment_outcome_recorded:'Verified experiment outcome recorded', creative_experiment_matrix_created:'Creative experiment matrix created', runbook_created:'Campaign Runbook created', runbook_recreated:'Campaign Runbook recreated', runbook_deleted:'Campaign Runbook deleted', runbook_paused:'Campaign Runbook paused', runbook_reopened:'Campaign Runbook reopened', runbook_archived:'Campaign Runbook archived', review_decision_recorded:'Human review decision recorded', learning_statement_saved:'Learning Statement saved', runbook_learning_promoted:'Runbook learning promoted',
}
