...
function StatusCard({ label, value, note, highlight = false }) {
  return <div className="studio-panel insights-status-card" style={{ padding:17, background:highlight ? 'linear-gradient(145deg,rgba(62,62,62,.56),rgba(22,22,22,.76))' : 'rgba(26,26,26,.42)', borderColor:highlight ? 'rgba(197,197,197,.36)' : 'rgba(240,240,240,.12)' }}><div className="studio-kicker" style={{ color:highlight ? 'var(--signal)' : 'rgba(240,240,240,.55)' }}>{label}</div><div className="insights-status-card__value" title={String(value)} style={{ color:'#ffffff', fontSize:23, fontWeight:850, letterSpacing:'-.05em', marginTop:8 }}>{value}</div>{note && <p className="insights-status-card__note" style={{ color:'rgba(240,240,240,.58)', fontSize:10.5, lineHeight:1.45, marginTop:6 }}>{note}</p>}</div>
}
