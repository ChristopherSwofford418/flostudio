...
export default function Accounts() {
  ...
  return <Layout title="Channels">
    <div className="flo-page channels-page" style={{ maxWidth:1080, margin:'0 auto', padding:'28px 30px 56px' }}>
      ...
      <section className="channels-control" style={{ marginTop:26 }}><div className="studio-kicker" style={{ color:'#c0c0c0' }}>CHANNEL CONTROL</div><h2 style={{ color:'#ffffff', fontSize:25, letterSpacing:'-.05em', marginTop:5 }}>Authorize a channel. Then map the <span className="studio-serif" style={{ color:'#c0c0c0' }}>real destination.</span></h2>
