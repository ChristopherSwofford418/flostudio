...
export default function Portfolio() {
  ...
  if (portfolioLoading) return <Layout title="Portfolio"><div className="studio-panel portfolio-feedback" style={{ padding:30, margin:'28px 30px', color:'rgba(240,240,240,.65)' }}>Loading your secure portfolio workspace…</div></Layout>
  if (workspaceError) return <Layout title="Portfolio"><div className="studio-panel portfolio-feedback" style={{ padding:30, margin:'28px 30px', color:'rgba(240,240,240,.72)' }}><div className="studio-kicker" style={{ color:'var(--signal)' }}>WORKSPACE CONNECTION</div><p style={{ marginTop:8, lineHeight:1.55 }}>{workspaceError}</p><button type="button" onClick={() => window.location.reload()} className="studio-button" style={{ marginTop:14 }}>Retry portfolio workspace →</button></div></Layout>
