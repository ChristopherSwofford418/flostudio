  ...
  return <Layout title="Campaign Engine">
    ...
    <div className="flo-page engine-ledger" style={{ maxWidth:1360, margin:'0 auto', animation:'engineEnter .42s var(--ease-out)' }}>
      <section className="studio-dark engine-header" style={{ position:'relative', overflow:'hidden', minHeight:296, padding:'37px 42px', marginBottom:18 }}>
        <div style={{ position:'absolute', width:420, height:420, right:-150, top:-230, borderRadius:'50%', background:'radial-gradient(circle,#c9f25d 0%,#4e735a 32%,rgba(78,115,90,0) 70%)', opacity:.66 }} />
        <div style={{ position:'absolute', width:240, height:240, right:120, bottom:-130, borderRadius:3, background:'linear-gradient(140deg,#c9f25d,#e76c48)', transform:'rotate(24deg)', opacity:.72 }} />
      ...
      <div className="engine-grid" style={{ display:'grid', gridTemplateColumns:'178px minmax(0,1fr) 290px', gap:18, alignItems:'start' }}>
        <aside className="engine-rail studio-panel" style={{ padding:'16px', background:'linear-gradient(160deg,#18372d,#10271f)', borderColor:'rgba(243,240,231,.13)' }}>
        ...
        <main className="studio-panel" style={{ overflow:'hidden', background:'linear-gradient(145deg,#17362c,#10271f)', borderColor:'rgba(201,242,93,.18)' }}>
